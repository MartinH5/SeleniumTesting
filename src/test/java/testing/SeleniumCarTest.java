...
public class SeleniumCarTest {
    ...
    public void Test5(){
        ...
        driver.findElement(By.id("registered")).sendKeys("2017-11-12");
        driver.findElement(By.id("make")).sendKeys("Volk's Wagen");
        driver.findElement(By.id("model")).sendKeys("UP");
        driver.findElement(By.id("description")).sendKeys("This is in fact a car");
